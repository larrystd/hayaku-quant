...
#include "app/runtime/SpotRecord.h"
#include "common/thread/FuncWrapper.h"
#include "common/thread/ThreadSafeQueue.h"
#include "execution/OrderRequest.h"
#include "execution/broker/OrderBrokerBase.h"
#include "execution/cost/TradeCostBase.h"
...
protected:
    ...
    std::unique_ptr<HikyuuSession> m_session;
