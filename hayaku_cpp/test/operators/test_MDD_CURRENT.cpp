...
TEST_CASE("test_MDD_CURRENT") {
  ...
  PriceList volatile_data{50.0, 60.0, 55.0, 70.0, 65.0,
                          80.0, 75.0, 85.0, 80.0, 90.0};
...
TEST_CASE("test_MDD_CURRENT_with_nan") {
  ...
  CHECK_EQ(mdd[4], doctest::Approx(104.7619).epsilon(
                       0.0001));  // -5, high 105 -> 104.7619%
  CHECK_EQ(mdd[5], doctest::Approx(14.2857).epsilon(
                       0.0001));  // 90, high 105 -> 14.2857%
