 ...
 * @ingroup StockManage
 */
KData HAYAKU_API getKData(const string& market_code, const Datetime& start = Datetime::min(),
 ...
 * @ingroup StockManage
 */
KData HAYAKU_API getKData(const string& market_code, int64_t start = 0, int64_t end = Null<int64_t>(),
                       const KQuery::KType& ktype = KQuery::DAY,
                       KQuery::RecoverType recoverType = KQuery::NO_RECOVER);
