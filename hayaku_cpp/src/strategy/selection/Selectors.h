 ...
 * @ingroup Selector
 */
SelectorPtr HAYAKU_API SE_Fixed(const StockList& stock_list, const internal::StrategyRuntimePtr& sys,
                             double weight = 1.0);
 ...
 * @ingroup Selector
 */
SelectorPtr HAYAKU_API SE_MultiFactor(const FactorSet& src_inds, int topn = 10, int ic_n = 5,
 ...
 * @ingroup Selector
 */
SelectorPtr HAYAKU_API SE_MultiFactor2(const FactorSet& factorset, int ic_n = 5,
                                    int ic_rolling_n = 120, const Stock& ref_stk = Stock(),
                                    bool spearman = true, const string& mode = "MF_ICIRWeight",
                                    const ScoresFilterPtr& filter = SCFilter_IgnoreNan());
 ...
 * @return SEPtr
 */
SEPtr HAYAKU_API SE_PerformanceOptimal(const string& key = "Account Avg Annual Return %",
                                    int mode = 0);
