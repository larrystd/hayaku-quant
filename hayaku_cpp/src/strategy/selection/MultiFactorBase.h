 ...
 * @ingroup MultiFactor
 */
class HAYAKU_API MultiFactorBase : public enable_shared_from_this<MultiFactorBase> {
    PARAMETER_SUPPORT_WITH_CHECK

public:
    typedef Indicator::value_t value_t;
    friend HAYAKU_API std::ostream& operator<<(std::ostream&, const MultiFactorBase&);
