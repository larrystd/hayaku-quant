...
size_t H5KDataDriver::getCount(const string& market, const string& code,
    ...
    try {
        ...
        // HAYAKU_WARN("Exception of some HDF5 operator! stock: {}{} {}", market, code,
...
bool H5KDataDriver::_getOtherIndexRangeByDate(const string& market, const string& code,
    ...
    H5FilePtr h5file;
    H5::Group group;
    HAYAKU_IF_RETURN(!_getH5FileAndGroup(market, code, query.kType(), h5file, group), false);
...
KRecordList H5KDataDriver::_getBaseKRecordList(const string& market, const string& code,
    ...
    H5FilePtr h5file;
    H5::Group group;
    HAYAKU_IF_RETURN(!_getH5FileAndGroup(market, code, kType, h5file, group), result);
...
KRecordList H5KDataDriver::_getIndexKRecordList(const string& market, const string& code,
    ...
    HAYAKU_IF_RETURN(!_getH5FileAndGroup(market, code, kType, h5file, index_group), result);
...
TimeLineList H5KDataDriver::_getTimeLine(const string& market, const string& code, int64_t start_ix,
    ...
    H5FilePtr h5file;
    H5::Group group;
    HAYAKU_IF_RETURN(!_getH5FileAndGroup(market, code, KQuery::TIMELINE, h5file, group), result);
...
TransList H5KDataDriver::_getTransList(const string& market, const string& code, int64_t start_ix,
    ...
    H5FilePtr h5file;
    H5::Group group;
    HAYAKU_IF_RETURN(!_getH5FileAndGroup(market, code, KQuery::TRANS, h5file, group), result);
