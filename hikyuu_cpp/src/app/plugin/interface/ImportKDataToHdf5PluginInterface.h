...
public:
     ...
     * @note It takes effect only after reopening HikyuuSession following the registration; the
     ...
     * @note It takes effect only after reopening HikyuuSession following the registration
     */
