...
from hayaku.extensions.ingest.sources.stock.zh_stock_a_qmt import parse_one_result_qmt, get_spot
from hayaku.application.gui.spot_server import release_nng_senders, start_send_spot, end_send_spot, send_spot
...
if __name__ == "__main__":
    ...
    from hayaku._support import hayaku_error, hayaku_info_if
