...
#define TABLE_BIND14(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
                     f11, f12, f13, f14)                                       \
 public:                                                                       \
  TableT() = default;                                                          \
  TableT(const TableT&) = default;                                             \
...
#define TABLE_BIND15(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
                     f11, f12, f13, f14, f15)                                  \
 public:                                                                       \
  TableT() = default;                                                          \
  TableT(const TableT&) = default;                                             \
...
#define TABLE_BIND16(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
...
#define TABLE_BIND17(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
...
#define TABLE_BIND18(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
...
#define TABLE_BIND19(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
...
#define TABLE_BIND20(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,   \
...
// ROWID: because the MYSQL and SQLITE syntaxes are different, it must be
...
#define TABLE_NO_AUTOID_BIND6(ROWID, table, f1, f2, f3, f4, f5, f6)            \
 ...
 public:                                                                       \
  ...
  static const char* getSelectSQL() {                                          \
    return "select `" #f1 "`,`" #f2 "`,`" #f3 "`,`" #f4 "`,`" #f5 "`,`" #f6    \
           "` from `" #table "`";                                              \
  }                                                                            \
  void save(const SQLStatementPtr& st) const {                                 \
    st->bind(0, f1, f2, f3, f4, f5, f6);                                       \
...
#define TABLE_NO_AUTOID_BIND18(ROWID, table, f1, f2, f3, f4, f5, f6, f7, f8,   \
                               f9, f10, f11, f12, f13, f14, f15, f16, f17,     \
                               f18)                                            \
 private:                                                                      \
  uint64_t m_rowid = 0;                                                        \
...
#define TABLE_NO_AUTOID_BIND19(ROWID, table, f1, f2, f3, f4, f5, f6, f7, f8,   \
                               f9, f10, f11, f12, f13, f14, f15, f16, f17,     \
                               f18, f19)                                       \
 private:                                                                      \
  uint64_t m_rowid = 0;                                                        \
...
#define TABLE_NO_AUTOID_BIND20(ROWID, table, f1, f2, f3, f4, f5, f6, f7, f8,   \
                               f9, f10, f11, f12, f13, f14, f15, f16, f17,     \
                               f18, f19, f20)                                  \
 private:                                                                      \
  uint64_t m_rowid = 0;                                                        \
...
//-------------------------------------------------------------------
//
// The ID must be specified explicitly, used in the case where DuckDB or a
// column database cannot generate the ID automatically
//
//-------------------------------------------------------------------
...
#define COL_TABLE_BIND14(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,    \
                         f10, f11, f12, f13, f14)                              \
 public:                                                                       \
  TableT() = default;                                                          \
  TableT(const TableT&) = default;                                             \
...
#define COL_TABLE_BIND15(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,   \
...
#define COL_TABLE_BIND16(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,   \
...
#define COL_TABLE_BIND17(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,   \
...
#define COL_TABLE_BIND18(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,    \
...
#define COL_TABLE_BIND19(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,   \
...
#define COL_TABLE_BIND20(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9,   \
                         f10, f11, f12, f13, f14, f15, f16, f17, f18, f19,    \
                         f20)                                                 \
 public:                                                                      \
  TableT() = default;                                                         \
