...
#define TA_IN1_OUT_N_PY(func, period, doc)                                   \
  ...
  m.def(#func, py::overload_cast<const Indicator&, int>(func),               \
        py::arg("data"), py::arg("n") = period, doc);

#define TA_IN2_OUT_PY(func, description)                                    \
  m.def(#func, py::overload_cast<bool>(func), py::arg("fill_null") = true); \
  m.def(#func,                                                              \
        py::overload_cast<const Indicator&, const Indicator&, bool>(func),  \
...
#define TA_IN2_OUT_N_PY(func, period, description)                            \
  ...
  m.def(                                                                      \
      #func,                                                                  \
      py::overload_cast<const Indicator&, const Indicator&, int, bool>(func), \
      py::arg("ind1"), py::arg("ind2"), py::arg("n") = period,                \
      py::arg("fill_null") = true, description);
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_ADOSC", py::overload_cast<int, int>(TA_ADOSC),
        py::arg("fast_n") = 3, py::arg("slow_n") = 10);
  m.def("TA_ADOSC", py::overload_cast<const KData&, int, int>(TA_ADOSC),
        py::arg("data"), py::arg("fast_n") = 3, py::arg("slow_n") = 10,
        R"(TA_ADOSC - Chaikin A/D Oscillator
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_K_OUT_N_PY(TA_ADXR, 14,
                R"(TA_ADXR - Average Directional Movement Index Rating

:param KData data: input KData
:param int n: Number of period (From 2 to 100000))")

  m.def("TA_APO", py::overload_cast<int, int, int>(TA_APO),
        py::arg("fast_n") = 12, py::arg("slow_n") = 26, py::arg("matype") = 0);
  m.def("TA_APO", py::overload_cast<const Indicator&, int, int, int>(TA_APO),
        py::arg("data"), py::arg("fast_n") = 12, py::arg("slow_n") = 26,
        py::arg("matype") = 0,
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_BBANDS", py::overload_cast<int, double, double, int>(TA_BBANDS),
        py::arg("n") = 5, py::arg("nbdevup") = 2., py::arg("nbdevdn") = 2.,
        py::arg("matype") = 0);
  m.def(
      "TA_BBANDS",
      py::overload_cast<const Indicator&, int, double, double, int>(TA_BBANDS),
      py::arg("data"), py::arg("n") = 5, py::arg("nbdevup") = 2.,
      py::arg("nbdevdn") = 2., py::arg("matype") = 0,
      R"(TA_BBANDS - Bollinger Bands
...
:param float penetration: Percentage of penetration of a candle within another candle (>=0))")
  ...
  TA_K_OUT_PY(TA_CDLKICKINGBYLENGTH,
              "TA_CDLKICKINGBYLENGTH - Kicking - bull/bear determined by the "
              "longer marubozu")
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN2_OUT_N_PY(TA_CORREL, 30,
                  R"(TA_CORREL - Pearson's Correlation Coefficient (r)
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN1_OUT_PY(TA_HT_PHASOR,
                R"(TA_HT_PHASOR - Hilbert Transform - Phasor Components
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN1_OUT_N_PY(TA_LINEARREG_ANGLE, 14,
                  R"(TA_LINEARREG_ANGLE - Linear Regression Angle
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN1_OUT_N_PY(TA_LINEARREG_SLOPE, 14,
                  R"(TA_LINEARREG_SLOPE - Linear Regression Slope
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_MA", py::overload_cast<int, int>(TA_MA), py::arg("n") = 30,
        py::arg("matype") = 0);
  m.def("TA_MA", py::overload_cast<const Indicator&, int, int>(TA_MA),
        py::arg("data"), py::arg("n") = 30, py::arg("matype") = 0,
        R"(TA_MA - Moving average

:param Indicator data: input data
:param int n: Number of periode (From 1 to 100000)
:param int matype: Type of Moving Average)");

  m.def("TA_MACD", py::overload_cast<int, int, int>(TA_MACD),
        py::arg("fast_n") = 12, py::arg("slow_n") = 26,
        py::arg("signal_n") = 9);
  m.def("TA_MACD", py::overload_cast<const Indicator&, int, int, int>(TA_MACD),
        py::arg("data"), py::arg("fast_n") = 30, py::arg("slow_n") = 26,
        py::arg("signal_n") = 9,
...
:param int signal_n: Smoothing for the signal line (nb of period) (From 1 to 100000))");
  ...
  m.def("TA_MACDEXT",
        py::overload_cast<int, int, int, int, int, int>(TA_MACDEXT),
        py::arg("fast_n") = 12, py::arg("slow_n") = 26, py::arg("signal_n") = 9,
        py::arg("fast_matype") = 0, py::arg("slow_matype") = 0,
        py::arg("signal_matype") = 0);
  m.def("TA_MACDEXT",
        py::overload_cast<const Indicator&, int, int, int, int, int, int>(
            TA_MACDEXT),
        py::arg("data"), py::arg("fast_n") = 30, py::arg("slow_n") = 26,
        py::arg("signal_n") = 9, py::arg("fast_matype") = 0,
        py::arg("slow_matype") = 0, py::arg("signal_matype") = 0,
...
:param int signal_matype: Type of Moving Average for signal line)");
  ...
  TA_IN1_OUT_N_PY(
      TA_MACDFIX, 9,
      R"(TA_MACDFIX - Moving Average Convergence/Divergence Fix 12/26
...
:return: result(0) - outMACD
  ...
  m.def("TA_MAMA", py::overload_cast<double, double>(TA_MAMA),
        py::arg("fast_limit") = 5.000000e-1,
        py::arg("slow_limit") = 5.000000e-2);
  m.def("TA_MAMA", py::overload_cast<const Indicator&, double, double>(TA_MAMA),
        py::arg("data"), py::arg("fast_limit") = 5.000000e-1,
        py::arg("slow_limit") = 5.000000e-2,
...
:param float slow_limit: Slow limit (From 0.01 to 0.99))");
  ...
  m.def("TA_MAVP",
        py::overload_cast<const Indicator&, int, int, int, bool>(TA_MAVP),
        py::arg("ref_ind"), py::arg("min_n") = 2, py::arg("max_n") = 30,
        py::arg("matype") = 0, py::arg("fill_null") = true);
  m.def("TA_MAVP",
        py::overload_cast<const Indicator&, const Indicator&, int, int, int,
                          bool>(TA_MAVP),
        py::arg("ind1"), py::arg("ind2"), py::arg("min_n") = 2,
        py::arg("max_n") = 30, py::arg("fill_null") = true,
        py::arg("matype") = 0,
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN1_OUT_N_PY(TA_MININDEX, 30,
                  R"(TA_MININDEX - Index of lowest value over a specified period
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN1_OUT_N_PY(
      TA_MINMAX, 30,
      R"(TA_MINMAX - Lowest and highest values over a specified period
...
:param int n: Number of period (From 1 to 100000))")
  ...
  m.def("TA_PPO", py::overload_cast<int, int, int>(TA_PPO),
        py::arg("fast_n") = 12, py::arg("slow_n") = 26, py::arg("matype") = 0);
  m.def("TA_PPO", py::overload_cast<const Indicator&, int, int, int>(TA_PPO),
        py::arg("data"), py::arg("fast_n") = 12, py::arg("slow_n") = 26,
        py::arg("matype") = 0,
...
:param int n: Number of period (From 1 to 100000))")
  ...
  TA_IN1_OUT_N_PY(TA_ROC, 10,
                  R"(TA_ROC - Rate of change : ((price/prevPrice)-1)*100
...
:param int n: Number of period (From 1 to 100000))")
  ...
  TA_IN1_OUT_N_PY(TA_ROCR, 10,
                  R"(TA_ROCR - Rate of change ratio: (price/prevPrice)
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_SAR", py::overload_cast<double, double>(TA_SAR),
        py::arg("acceleration") = 0.02, py::arg("maximum") = 0.2);
  m.def("TA_SAR", py::overload_cast<const KData&, double, double>(TA_SAR),
        py::arg("data"), py::arg("acceleration") = 0.02,
        py::arg("maximum") = 0.2, R"(TA_SAR - Parabolic SAR
...
:param float maximum: Acceleration Factor Maximum value (>= 0.0))");
  ...
  m.def("TA_SAREXT",
        py::overload_cast<double, double, double, double, double, double,
                          double, double>(TA_SAREXT),
        py::arg("startvalue") = 0.0, py::arg("offsetonreverse") = 0.0,
        py::arg("accelerationinitlong") = 0.02,
        py::arg("accelerationlong") = 0.02,
        py::arg("accelerationmaxlong") = 0.2,
        py::arg("accelerationinitshort") = 0.02,
        py::arg("accelerationshort") = 0.02,
        py::arg("accelerationmaxshort") = 0.2);
  m.def(
      "TA_SAREXT",
      py::overload_cast<const KData&, double, double, double, double, double,
                        double, double, double>(TA_SAREXT),
      py::arg("data"), py::arg("startvalue") = 0.0,
      py::arg("offsetonreverse") = 0.0, py::arg("accelerationinitlong") = 0.02,
      py::arg("accelerationlong") = 0.02, py::arg("accelerationmaxlong") = 0.2,
      py::arg("accelerationinitshort") = 0.02,
      py::arg("accelerationshort") = 0.02,
      py::arg("accelerationmaxshort") = 0.2,
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_STDDEV", py::overload_cast<int, double>(TA_STDDEV),
        py::arg("n") = 5, py::arg("nbdev") = 1.0);
  m.def("TA_STDDEV",
        py::overload_cast<const Indicator&, int, double>(TA_STDDEV),
        py::arg("data"), py::arg("n") = 5, py::arg("nbdev") = 1.0,
        R"(TA_STDDEV - Standard Deviation

:param Indicator data: input data
:param int n: Number of period (From 2 to 100000)
:param float nbdev: Nb of deviations)");

  m.def("TA_STOCH", py::overload_cast<int, int, int, int, int>(TA_STOCH),
        py::arg("fastk_n") = 5, py::arg("slowk_n") = 3,
        py::arg("slowk_matype") = 0, py::arg("slowd_n") = 3,
        py::arg("slowd_matype") = 0);
  m.def("TA_STOCH",
        py::overload_cast<const KData&, int, int, int, int, int>(TA_STOCH),
...
:return: result0 - slow K
  ...
  m.def("TA_STOCHF", py::overload_cast<int, int, int>(TA_STOCHF),
        py::arg("fastk_n") = 5, py::arg("fastd_n") = 3,
        py::arg("fastd_matype") = 0);
  m.def("TA_STOCHF", py::overload_cast<const KData&, int, int, int>(TA_STOCHF),
        py::arg("data"), py::arg("fastk_n") = 5, py::arg("fastd_n") = 3,
        py::arg("fastd_matype") = 0,
...
:return: result0 - fast K
  ...
  m.def("TA_STOCHRSI", py::overload_cast<int, int, int, int>(TA_STOCHRSI),
        py::arg("n") = 14, py::arg("fastk_n") = 5, py::arg("fastd_n") = 3,
        py::arg("matype") = 0);
  m.def("TA_STOCHRSI",
        py::overload_cast<const Indicator&, int, int, int, int>(TA_STOCHRSI),
        py::arg("data"), py::arg("n") = 14, py::arg("fastk_n") = 5,
        py::arg("fastd_n") = 3, py::arg("matype") = 0,
        R"(TA_STOCHRSI - Stochastic Relative Strength Index
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_T3", py::overload_cast<const Indicator&, int, double>(TA_T3),
        py::arg("data"), py::arg("n") = 5, py::arg("vfactor") = 7.000000e-1,
...
:param int n: Number of period (From 2 to 100000))")
  ...
  TA_IN1_OUT_N_PY(TA_TRIX, 30,
                  R"(TA_TRIX - 1-day Rate-Of-Change (ROC) of a Triple Smooth EMA
...
:param int n: Number of period (From 2 to 100000))")
  ...
  m.def("TA_ULTOSC", py::overload_cast<int, int, int>(TA_ULTOSC),
        py::arg("n1") = 7, py::arg("n2") = 14, py::arg("n3") = 28);
  m.def("TA_ULTOSC", py::overload_cast<const KData&, int, int, int>(TA_ULTOSC),
        py::arg("data"), py::arg("n1") = 7, py::arg("n2") = 14,
        py::arg("n3") = 28,
...
:param int n3: Number of bars for 3rd period (From 1 to 100000))");
  ...
  m.def("TA_VAR", py::overload_cast<int, double>(TA_VAR), py::arg("n") = 5,
        py::arg("nbdev") = 1.0);
  m.def("TA_VAR", py::overload_cast<const Indicator&, int, double>(TA_VAR),
        py::arg("data"), py::arg("n") = 5, py::arg("nbdev") = 1.0,
        R"(TA_VAR - Variance
