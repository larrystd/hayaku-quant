 ...
 *
 * Stable identifiers for optional plugins. Keep this header free of plugin interface includes.
 */
...
inline constexpr const char* HAYAKU_PLUGIN_IMPORTKDATATOCLICKHOUSE = "import2ch";
...
inline constexpr const char* HAYAKU_PLUGIN_CLICKHOUSE_DRIVER = "clickhousedriver";
