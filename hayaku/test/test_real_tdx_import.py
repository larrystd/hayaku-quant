...
使用前提:
- 需要一个真实的通达信 .day 文件。测试默认会寻找环境变量 `HAYAKU_real_tdx_file_path` 指定的文件,
...
unittest.mock.patch('hayaku.hayaku_cleanup', lambda: None).start()

from hayaku.data.common_h5 import H5Record, get_h5table, open_h5file
# 假设要测试的函数位于以下模块
from hayaku.data.tdx_to_h5 import tdx_import_day_data_from_file
