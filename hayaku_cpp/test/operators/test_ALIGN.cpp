...
TEST_CASE("test_ALIGN_fill_null") {
  ...
  /** @arg The input indicator is context independent and the reference date
   * length is 0 */
  DatetimeList ref;
  ...
  /** @arg The input indicator is context independent and as long as the
   * reference date list */
  ...
  /** @arg The input indicator is context independent and longer than the
   * reference date list */
  a.push_back(11);
  data = PRICELIST(a);
  result = ALIGN(data, ref, false);
  ...
  /** @arg The input indicator is context independent and shorter than the
   * reference date list */
  a.clear();
  a.push_back(1);
  data = PRICELIST(a);
...
TEST_CASE("test_ALIGN_export") {
  ...
  Indicator x1 =
      ALIGN(CLOSE(kdata), sm.getStock("sh600004").getDatetimeList(KQuery(-20)));
  {
