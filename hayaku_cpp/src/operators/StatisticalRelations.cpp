...
Indicator HAYAKU_API BETA(const Indicator& ind1, const Indicator& ind2, int n, bool fill_null) {
...
Indicator HAYAKU_API CORR(const Indicator& ind1, const Indicator& ind2, int n, bool fill_null) {
...
Indicator HAYAKU_API COV(const Indicator& ind1, const Indicator& ind2, int n, bool fill_null) {
...
Indicator HAYAKU_API SPEARMAN(const Indicator &ind, const Indicator &ref_ind, int n, bool fill_null) {
...
Indicator HAYAKU_API QUANTILE_TRUNC(int n, double quantile_min, double quantile_max) {
