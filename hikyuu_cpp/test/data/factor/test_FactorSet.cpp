...
#include <atomic>
#include <data/factor/FactorSet.h>
#include <data/factor/Factor.h>
#include <data/factor/imp/CompiledFactorPlan.h>
#include <data/indicator/IndicatorImp.h>
#include <data/indicator/crt/ALIGN.h>
#include <data/indicator/crt/CONTEXT.h>
#include <data/indicator/crt/CORR.h>
#include <data/indicator/crt/CVAL.h>
#include <data/indicator/crt/EMA.h>
#include <data/indicator/crt/FACTOR.h>
#include <data/indicator/crt/MA.h>
#include <data/indicator/crt/KDATA.h>
#include <data/indicator/crt/REF.h>
#include <data/indicator/crt/STDEV.h>
...
TEST_CASE("test_FactorSet_getValues") {
    ...
    StockList stocks;
    // Since DataRuntime is not initialized, an empty list is used here for the test
...
TEST_CASE("test_FactorSet_integration") {
    ...
    SUBCASE("DataRuntime integration") {
        ...
        // Note: the real result depends on the state of DataRuntime; only no exception is tested
        // here
    }
