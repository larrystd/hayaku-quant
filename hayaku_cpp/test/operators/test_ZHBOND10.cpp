...
TEST_CASE("test_ZHBOND10") {
  ...
  /** @arg The input date list, all the given dates are earlier than the
   * earliest bond date */
  ...
  /** @arg The input date list, all the given dates are later than the latest
   * bond date */
  ...
  /** @arg The input date list; some of the given dates are not in the yield
   * list */
  ...
  k = getKData("sh000001",
               KQueryByDate(Datetime(20011226), Datetime(20020111)));
