...
void export_extend_Indicator(py::module& m) {
    ...
    m.def(
      ...
      [](const Indicator& ind, py::object agg_func, const KQuery::KType& ktype, bool fill_null,
         int unit) {
          ...
          HAYAKU_CHECK(py::hasattr(agg_func, "__call__"), "agg_func not callable!");
          HAYAKU_CHECK(check_pyfunction_arg_num(agg_func, 2), "Number of parameters does not match!");
    ...
    m.def(
      ...
      [](const Indicator& ind, py::object group_func, const KQuery::KType& ktype, int unit) {
          ...
          HAYAKU_CHECK(py::hasattr(group_func, "__call__"), "agg_func not callable!");
