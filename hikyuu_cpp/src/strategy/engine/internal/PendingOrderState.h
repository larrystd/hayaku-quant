...
#pragma once
#ifndef HIKYUU_TRADE_SYS_ENGINE_INTERNAL_PENDINGORDERSTATE_H
#define HIKYUU_TRADE_SYS_ENGINE_INTERNAL_PENDINGORDERSTATE_H
...
#endif /* HIKYUU_TRADE_SYS_ENGINE_INTERNAL_PENDINGORDERSTATE_H */
