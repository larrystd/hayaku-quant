...
// Registration group: _HayakuSession
/*
...
void export_HayakuSession(py::module& m) {
  py::class_<HayakuSession>(m, "HayakuSession",
                            "Explicit Hayaku runtime session")
      .def_static(
          "open",
          py::overload_cast<const string&, bool, const StrategyContext&>(
              &HayakuSession::open),
      ...
      .def_static(
          "open",
          [](const string& filename, const AccountConfig& accountConfig,
             bool ignorePreload, const StrategyContext& context) {
            return HayakuSession::open(
                SessionOptions::fromIni(filename, ignorePreload, context),
                accountConfig);
          },
          py::arg("filename"), py::arg("account_config"),
          py::arg("ignore_preload") = false,
          py::arg("context") = StrategyContext({"all"}),
          py::call_guard<py::gil_scoped_release>())
      ...
      .def_property_readonly("execution",
                             py::overload_cast<>(&HayakuSession::execution),
                             py::return_value_policy::reference_internal)
      .def_property_readonly("strategy",
                             py::overload_cast<>(&HayakuSession::strategy),
                             py::return_value_policy::reference_internal)
      .def("wait_ready", &HayakuSession::waitReady,
           py::call_guard<py::gil_scoped_release>())
      .def(
          "__enter__",
          [](HayakuSession& self) -> HayakuSession& { return self; },
          py::return_value_policy::reference_internal)
      .def("__exit__", [](HayakuSession& self, const py::object&,
...
// Registration group: application_main
/*
 * Copyright (c) 2026 hikyuu.org
 */
...
void export_application_main(py::module& m) { export_HayakuSession(m); }

// Registration group: _device
/*
...
void export_plugin_device(py::module& m) {
  ...
  m.def("active_device", &activeDevice, py::arg("code"),
  ...
  m.def("fetch_trial_license", &fetchTrialLicense,
        R"(fetch_trial_license(email: str)
...
#define PY_AGG_IND_DEFINE(agg_func, doc)                                      \
  m.def(#agg_func,                                                            \
        py::overload_cast<const Indicator&, const KQuery::KType&, bool, int>( \
            &agg_func),                                                       \
        py::arg("ind"), py::arg("ktype") = KQuery::MIN,                       \
        py::arg("fill_null") = false, py::arg("unit") = 1, doc);
...
class PyAggFunc {
 ...
 public:
  ...
  Indicator::value_t operator()(const DatetimeList& src_ds,
    ...
    std::copy(src_ds.begin() + group_start, src_ds.begin() + group_last + 1,
              ds.begin());
...
#define PY_GROUP_IND_DEFINE(group_func, doc)                                 \
  m.def(#group_func,                                                         \
        py::overload_cast<const Indicator&, const KQuery::KType&, int>(      \
            &group_func),                                                    \
        py::arg("ind"), py::arg("ktype") = KQuery::DAY, py::arg("unit") = 1, \
        doc);
...
class PyGroupFunc {
 ...
 public:
  ...
  void operator()(Indicator::value_t* dst, const DatetimeList& src_ds,
    ...
    HAYAKU_CHECK(ret.shape()[0] == shape[0],
                 "The length of the return value of the Python function is "
                 "inconsistent with "
                 "the input!");
    const Indicator::value_t* data =
        ret.data();  // The data pointer (accessing the underlying memory
                     // directly)
...
void export_extend_Indicator(py::module& m) {
  ...
  m.def("FIXED_START_INDEX",
        py::overload_cast<const Indicator&, int>(FIXED_START_INDEX),
  ...
  m.def("FIXED_START_DATE",
        py::overload_cast<const Datetime&>(FIXED_START_DATE),
        py::arg("start_date") = Datetime::min());
  m.def("FIXED_START_DATE",
        py::overload_cast<const Indicator&, const Datetime&>(FIXED_START_DATE),
        py::arg("ind"), py::arg("start_date") = Datetime::min(),
  ...
  m.def("WITHKTYPE", py::overload_cast<const KQuery::KType&, bool>(WITHKTYPE),
        py::arg("ktype"), py::arg("fill_null") = false);
  m.def("WITHKTYPE",
        py::overload_cast<const Indicator&, const KQuery::KType&, bool>(
            WITHKTYPE),
  ...
  m.def("WITHDAY", py::overload_cast<bool>(WITHDAY),
        py::arg("fill_null") = false);
  m.def("WITHDAY", py::overload_cast<const Indicator&, bool>(WITHDAY),
  ...
  m.def("WITHWEEK", py::overload_cast<bool>(WITHWEEK),
        py::arg("fill_null") = false);
  m.def("WITHWEEK", py::overload_cast<const Indicator&, bool>(WITHWEEK),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHMONTH", py::overload_cast<bool>(WITHMONTH),
        py::arg("fill_null") = false);
  m.def("WITHMONTH", py::overload_cast<const Indicator&, bool>(WITHMONTH),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHQUARTER", py::overload_cast<bool>(WITHQUARTER),
        py::arg("fill_null") = false);
  m.def("WITHQUARTER", py::overload_cast<const Indicator&, bool>(WITHQUARTER),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHHALFYEAR", py::overload_cast<bool>(WITHHALFYEAR),
        py::arg("fill_null") = false);
  m.def("WITHHALFYEAR", py::overload_cast<const Indicator&, bool>(WITHHALFYEAR),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHYEAR", py::overload_cast<bool>(WITHYEAR),
        py::arg("fill_null") = false);
  m.def("WITHYEAR", py::overload_cast<const Indicator&, bool>(WITHYEAR),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHMIN", py::overload_cast<bool>(WITHMIN),
        py::arg("fill_null") = false);
  m.def("WITHMIN", py::overload_cast<const Indicator&, bool>(WITHMIN),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHMIN5", py::overload_cast<bool>(WITHMIN5),
        py::arg("fill_null") = false);
  m.def("WITHMIN5", py::overload_cast<const Indicator&, bool>(WITHMIN5),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHMIN15", py::overload_cast<bool>(WITHMIN15),
        py::arg("fill_null") = false);
  m.def("WITHMIN15", py::overload_cast<const Indicator&, bool>(WITHMIN15),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHMIN30", py::overload_cast<bool>(WITHMIN30),
        py::arg("fill_null") = false);
  m.def("WITHMIN30", py::overload_cast<const Indicator&, bool>(WITHMIN30),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHMIN60", py::overload_cast<bool>(WITHMIN60),
        py::arg("fill_null") = false);
  m.def("WITHMIN60", py::overload_cast<const Indicator&, bool>(WITHMIN60),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHHOUR", py::overload_cast<bool>(WITHHOUR),
        py::arg("fill_null") = false);
  m.def("WITHHOUR", py::overload_cast<const Indicator&, bool>(WITHHOUR),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHHOUR2", py::overload_cast<bool>(WITHHOUR2),
        py::arg("fill_null") = false);
  m.def("WITHHOUR2", py::overload_cast<const Indicator&, bool>(WITHHOUR2),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def("WITHHOUR4", py::overload_cast<bool>(WITHHOUR4),
        py::arg("fill_null") = false);
  m.def("WITHHOUR4", py::overload_cast<const Indicator&, bool>(WITHHOUR4),
        py::arg("ind"), py::arg("fill_null") = false,
  ...
  m.def(
      "RANK",
      [](const py::object& stks, int mode, bool fill_null,
         const string& market) {
        Block blk;
        blk.add(get_stock_list_from_python(stks));
        return RANK(blk, mode, fill_null, market);
      },
      py::arg("stks"), py::arg("mode") = 0, py::arg("fill_null") = true,
      py::arg("market") = "SH");
  m.def(
      "RANK",
      [](const py::sequence stks, const Indicator& ref_ind, int mode,
         bool fill_null, const string& market) {
        Block blk;
        blk.add(get_stock_list_from_python(stks));
        return RANK(blk, ref_ind, mode, fill_null, market);
      },
      py::arg("stks"), py::arg("ref_ind"), py::arg("mode") = 0,
      py::arg("fill_null") = true, py::arg("market") = "SH",
  ...
  PY_AGG_IND_DEFINE(AGG_COUNT,
                    "The aggregation function: the non-empty value counting, "
                    "refer to the AGG_STD help")
  PY_AGG_IND_DEFINE(
      AGG_SUM,
      "The aggregation function: the total sum, refer to the AGG_STD help")
  PY_AGG_IND_DEFINE(
      AGG_MAX,
  ...
  PY_AGG_IND_DEFINE(AGG_MAD,
                    "The aggregation function: the average absolute deviation, "
                    "refer to the AGG_STD help")
  PY_AGG_IND_DEFINE(
      AGG_MEDIAN,
      "The aggregation function: the median, refer to the AGG_STD help")
  PY_AGG_IND_DEFINE(
      AGG_PROD,
      "The aggregation function: the product, refer to the AGG_STD help")

  m.def(
      "AGG_SAMPLE",
      py::overload_cast<const Indicator&, const string&, const KQuery::KType&,
                        bool, int>(&AGG_SAMPLE),
  ...
  m.def(
      "AGG_SAMPLE_MAX",
      py::overload_cast<const Indicator&, const string&, const string&,
                        const KQuery::KType&, bool, int>(&AGG_SAMPLE_MAX),
      py::arg("ind"), py::arg("start_time") = "9:30",
      py::arg("last_time") = "10:00", py::arg("ktype") = KQuery::MIN,
      py::arg("fill_null") = false, py::arg("unit") = 1,
  ...
  m.def(
      "AGG_SAMPLE_MIN",
      py::overload_cast<const Indicator&, const string&, const string&,
                        const KQuery::KType&, bool, int>(&AGG_SAMPLE_MIN),
      py::arg("ind"), py::arg("start_time") = "9:30",
      py::arg("last_time") = "10:00", py::arg("ktype") = KQuery::MIN,
      py::arg("fill_null") = false, py::arg("unit") = 1,
  ...
  m.def(
      "AGG_SAMPLE_MEAN",
      py::overload_cast<const Indicator&, const string&, const string&,
                        const KQuery::KType&, bool, int>(&AGG_SAMPLE_MEAN),
      py::arg("ind"), py::arg("start_time") = "9:30",
      py::arg("last_time") = "10:00", py::arg("ktype") = KQuery::MIN,
      py::arg("fill_null") = false, py::arg("unit") = 1,
  ...
  m.def(
      "AGG_STD",
      py::overload_cast<const Indicator&, const KQuery::KType&, bool, int, int>(
          &AGG_STD),
      py::arg("ind"), py::arg("ktype") = KQuery::MIN,
      py::arg("fill_null") = false, py::arg("unit") = 1, py::arg("ddof") = 1,
  ...
  m.def("AGG_VWAP",
        py::overload_cast<const KData&, const KQuery::KType&, bool, int>(
            &AGG_VWAP),
        py::arg("k"), py::arg("ktype") = KQuery::MIN,
        py::arg("fill_null") = false, py::arg("unit") = 1);
  m.def("AGG_VWAP",
        py::overload_cast<const KQuery::KType&, bool, int>(&AGG_VWAP),
  ...
  m.def(
      "AGG_FUNC",
      [](const Indicator& ind, py::object agg_func, const KQuery::KType& ktype,
         bool fill_null, int unit) {
        HAYAKU_CHECK(!agg_func.is_none(), "agg_func is None!");
        HAYAKU_CHECK(py::hasattr(agg_func, "__call__"),
                     "agg_func not callable!");
        HAYAKU_CHECK(check_pyfunction_arg_num(agg_func, 2),
  ...
  m.def(
      "GROUP_FUNC",
      [](const Indicator& ind, py::object group_func,
         const KQuery::KType& ktype, int unit) {
        HAYAKU_CHECK(!group_func.is_none(), "group_func is None!");
        HAYAKU_CHECK(py::hasattr(group_func, "__call__"),
                     "agg_func not callable!");
        HAYAKU_CHECK(check_pyfunction_arg_num(group_func, 2),
                     "Number of parameters does not match!");
...
// Registration group: _hayakuextra
/*
 *  Copyright (c) 2025 hikyuu.org
 *
...
#include <application/plugins/ExtraPlugins.h>
...
void export_hayakuextra(py::module& m) {
  ...
  m.def("register_extra_ktype",
    ...
    Note:
    1. Hayaku has built in the DAY3, DAY5, DAY7 based on the number of the Bars, and the MIN3 extended K-line based on the time conversion
...
// Registration group: _plugin_main
/*
 *  Copyright (c) 2025 hikyuu.org
 *
 *  Created on: 2025-04-12
