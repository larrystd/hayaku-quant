...
TEST_CASE("test_TS_RANK_base") {
  Indicator ind =
      PRICELIST({5.0, 3.0, 8.0, 3.0, 2.0, 9.0, 1.0, 7.0, 4.0, 6.0}, 0);
  ...
  Indicator expect =
      PRICELIST({nan, nan, nan, nan, 0.2, 1.0, 0.2, 0.8, 0.6, 0.6}, 4);
...
/** @par Test point: the basic functionality of the TS_RANK incremental
 * calculation */
