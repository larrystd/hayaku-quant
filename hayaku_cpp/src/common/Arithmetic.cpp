...
template double HAYAKU_UTILS_API get_quantile(const std::vector<double> &vec, double quantile);
template float HAYAKU_UTILS_API get_quantile(const std::vector<float> &vec, double quantile);
