...
def shell_cmd(func):
    ...
    def wrapcmd(*args, **kargs):
        try:
            ...
            self.__class__.prompt = '\033[32;40mHAYAKU [\033[0m\033[1;32;40m%s\033[0m\033[32;40m]:\033[0m ' % self.__class__.lineno
...
class HAYAKUShell(cmd.Cmd):
    ...
    \033[0m
    \033[33m\033[1m  Welcome to the hayaku shell. Type help or ? to list commands.\033[0m

    """
    lineno = 1
    prompt = '\033[32;40mHAYAKU [\033[0m\033[1;32;40m%s\033[0m\033[32;40m]:\033[0m ' % lineno
    file = None
    server = None
    ...
    def do_quit(self, arg):
        ...
        print('Thank you for using hayaku.\n')
        return True
