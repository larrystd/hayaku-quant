...
//===========================================================================
// The following is the serialization of Stock; currently only the serialization
// of the Stock managed by the data runtime is implemented Note: this piece of
// code is outside namespace hayaku
// TODO implement the serialization of a Stock that is not managed by the data
// runtime
//===========================================================================
