CREATE TABLE IF NOT EXISTS `hayaku_base`.`stkfinance` (
    ...
    `baoliu2` DOUBLE NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`stockid`) REFERENCES `hayaku_base`.`stock` (`stockid`), INDEX `ix_stkfinance_date` (`updated_date`), INDEX `ix_stkfinance_stock_date` (`stockid`, `updated_date`)
) COLLATE = 'utf8mb4_general_ci' ENGINE = InnoDB;

UPDATE `hayaku_base`.`version` set `version` = 9;