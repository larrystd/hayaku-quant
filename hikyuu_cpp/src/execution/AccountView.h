...
#pragma once
#ifndef HIKYUU_TRADE_ACCOUNTVIEW_H
#define HIKYUU_TRADE_ACCOUNTVIEW_H
...
class HKU_API AccountView {
public:
    AccountView(AccountId id, Datetime initDatetime, Datetime lastDatetime, FundsRecord funds,
                PositionRecordList positions, PositionRecordList shortPositions)
    : m_id(id),
    ...
    [[nodiscard]] AccountId id() const noexcept {
        return m_id;
    }
...
#endif /* HIKYUU_TRADE_ACCOUNTVIEW_H */
