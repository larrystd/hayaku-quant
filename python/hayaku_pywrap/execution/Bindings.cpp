...
void export_PositionRecord(py::module& m) {
      ...
      [](const PositionRecordList& positions) {
        ...
        py::dtype dtype = py::dtype(
            vector_to_python_list<string>(
                {"market_code", "stock_name", "take_time", "hold_days",
                 "hold_number", "invest", "market_value", "profit",
                 "profit_percent", "stoploss", "goal_price", "clean_time",
                 "total_number", "total_cost", "total_risk", "buy_money",
                 "sell_money"}),
            vector_to_python_list<string>(
  ...
  m.def(
      ...
      [](const PositionRecordList& positions) {
        ...
        columns["take_time"] = take_time_arr.attr("astype")("datetime64[ns]");
        columns["hold_days"] = hold_days_arr;
        columns["hold_number"] = hold_number_arr;
        columns["invest"] = invest_arr;
        columns["market_value"] = market_value_arr;
        columns["profit"] = profit_arr;
        columns["profit_percent"] = profit_percent_arr;
        columns["stoploss"] = stoploss_arr;
        columns["goal_price"] = goal_price_arr;
        columns["clean_time"] = clean_time_arr.attr("astype")("datetime64[ns]");
        columns["total_number"] = total_number_arr;
        columns["total_cost"] = total_cost_arr;
        columns["total_risk"] = total_risk_arr;
        columns["buy_money"] = buy_money_arr;
        columns["sell_money"] = sell_money_arr;
...
void export_TradeRecord(py::module& m) {
  ...
  m.def("trades_to_np", [](const TradeRecordList& trades) {
    ...
    py::dtype dtype = py::dtype(
        vector_to_python_list<string>(
            {"market_code", "stock_name", "datetime", "business", "planPrice",
             "realPrice", "goalPrice", "number", "stoploss", "cash",
             "cost_total", "cost_commission", "cost_stamptax",
             "cost_transferfee", "cost_others", "origin", "remark"}),
        vector_to_python_list<string>({"U10", "U20", "datetime64[ns]", "U20",
                                       "d", "d", "d", "d", "d", "d", "d", "d",
                                       "d", "d", "d", "U20", "U100"}),
        vector_to_python_list<int64_t>({0, 40, 120, 128, 208, 216, 224, 232,
  ...
  m.def(
      ...
      [](const TradeRecordList& trades) {
        ...
        columns["planPrice"] = planPrice_arr;
        columns["realPrice"] = realPrice_arr;
        columns["goalPrice"] = goalPrice_arr;
        columns["number"] = number_arr;
        columns["stoploss"] = stoploss_arr;
        columns["cash"] = cash_arr;
        columns["cost_total"] = cost_total_arr;
        columns["cost_commission"] = cost_commission_arr;
        columns["cost_stamptax"] = cost_stamptax_arr;
        columns["cost_transferfee"] = cost_transferfee_arr;
        columns["cost_others"] = cost_others_arr;
        columns["origin"] =
