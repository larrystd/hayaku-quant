 ...
 * @note The registration happens only in the data-runtime initialization negotiation period, and
 ...
 */
HAYAKU_API bool forwardRealtimeUpdate(const std::string& market_code, const KQuery::KType& ktype,
                                   const KRecord& record);
 ...
 */
HAYAKU_API bool forwardPullFromBufferServer(const std::string& addr,
