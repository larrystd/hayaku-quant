...
HAYAKU_API std::ostream& operator<<(std::ostream& os, const BrokerPositionRecord& pos) {
    os << pos.str();
    return os;
}

HAYAKU_API std::ostream& operator<<(std::ostream& os, const OrderBrokerBase& broker) {
    os << "OrderBroker(" << broker.name() << ")";
    return os;
}

HAYAKU_API std::ostream& operator<<(std::ostream& os, const OrderBrokerPtr& broker) {
    os << "OrderBroker(" << broker->name() << ")";
    return os;
}
