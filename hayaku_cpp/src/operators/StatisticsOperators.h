 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API ZSCORE(bool outExtreme = false, double nsigma = 3.0, bool recursive = false);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API BETA(const Indicator& ind1, const Indicator& ind2, int n = 10,
                       bool fill_null = true);
Indicator HAYAKU_API BETA(const Indicator& ref_ind, int n = 10, bool fill_null = true);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API CORR(const Indicator& ind1, const Indicator& ind2, int n = 10,
                       bool fill_null = true);
Indicator HAYAKU_API CORR(const Indicator& ref_ind, int n = 10, bool fill_null = true);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API COV(const Indicator& ind1, const Indicator& ind2, int n = 10,
                      bool fill_null = true);
Indicator HAYAKU_API COV(const Indicator& ref_ind, int n = 10, bool fill_null = true);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API SPEARMAN(const Indicator& ind, const Indicator& ref_ind, int n = 0,
                           bool fill_null = true);
Indicator HAYAKU_API SPEARMAN(const Indicator& ref_ind, int n = 0, bool fill_null = true);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API IC(const StockList& stks, int n = 1, bool spearman = true, bool strict = false);

Indicator HAYAKU_API IC(const Block& blk, int n = 1, bool spearman = true, bool strict = false);
 ...
 *               t+1"
 */
Indicator HAYAKU_API IC(IndicatorList inds, IndicatorList returns, int n = 1, bool use_spearman = true,
                     bool strict = false);
