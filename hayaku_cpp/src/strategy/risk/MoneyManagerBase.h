 ...
 */
class HAYAKU_API MoneyManagerBase : public enable_shared_from_this<MoneyManagerBase> {
...
public:
    ...
    virtual double _getBuyNumber(const Datetime& datetime, const Stock& stock, price_t price,
                                 price_t risk, OrderOrigin origin) = 0;
...
private:
    ...
    void save(Archive& ar, const unsigned int version) const {
        ...
        // m_query and m_account are set temporarily when the strategy runs, they do not need to be
        // serialized
        // ar & BOOST_SERIALIZATION_NVP(m_query);
        // ar & BOOST_SERIALIZATION_NVP(m_account);
    }
...
public:                                                                                       \
    ...
    virtual double _getBuyNumber(const Datetime& datetime, const Stock& stock, price_t price, \
                                 price_t risk, OrderOrigin origin) override;
