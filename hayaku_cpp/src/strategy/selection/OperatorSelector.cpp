...
std::unordered_set<internal::StrategyRuntime*> OperatorSelector::findIntersection(const SelectorPtr& se1,
...
void OperatorSelector::sortStrategyWeightList(StrategyWeightList& swlist) {
    std::sort(swlist.begin(), swlist.end(), [](const StrategyWeight& a, const StrategyWeight& b) {
