...
std::pair<std::string, vector<std::string>> HAYAKU_API checkData(const StockList& stock_list,
    ...
    HAYAKU_ERROR_IF_RETURN(!plugin, ret, htr("Can't find {} plugin!", HAYAKU_PLUGIN_CHECK_DATA));
