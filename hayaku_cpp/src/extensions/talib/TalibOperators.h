...
#define TA_IN2_OUT_CRT(func)                                                                     \
    Indicator HAYAKU_API func(const Indicator& ind1, const Indicator& ind2, bool fill_null = true); \
    Indicator HAYAKU_API func(bool fill_null = true);

#define TA_IN2_OUT_N_CRT(func, period)                                                   \
    Indicator HAYAKU_API func(const Indicator& ind1, const Indicator& ind2, int n = period, \
                           bool fill_null = true);                                       \
...
Indicator HAYAKU_API TA_BBANDS(int n = 5, double nbdevup = 2., double nbdevdn = 2., int matype = 0);
...
Indicator HAYAKU_API TA_MACD(int fast_n = 12, int slow_n = 26, int signal_n = 9);
...
Indicator HAYAKU_API TA_MACDEXT(int fast_n = 12, int slow_n = 26, int signal_n = 9,
...
Indicator HAYAKU_API TA_MAMA(double fast_limit = 5.000000e-1, double slow_limit = 5.000000e-2);
...
Indicator HAYAKU_API TA_MAVP(const Indicator& ref_ind, int min_n = 2, int max_n = 30, int matype = 0,
                          bool fill_null = true);
...
Indicator HAYAKU_API TA_SAR(const KData& k, double acceleration = 0.02, double maximum = 0.2);

Indicator HAYAKU_API TA_SAREXT(double startvalue = 0.0, double offsetonreverse = 0.0,
...
Indicator HAYAKU_API TA_SAREXT(const KData& k, double startvalue = 0.0, double offsetonreverse = 0.0,
                            double accelerationinitlong = 0.02, double accelerationlong = 0.02,
                            double accelerationmaxlong = 0.2, double accelerationinitshort = 0.02,
                            double accelerationshort = 0.02, double accelerationmaxshort = 0.2);
...
Indicator HAYAKU_API TA_STOCH(int fastk_n = 5, int slowk_n = 3, int slowk_matype = 0, int slowd_n = 3,
                           int slowd_matype = 0);
Indicator HAYAKU_API TA_STOCH(const KData& k, int fastk_n = 5, int slowk_n = 3, int slowk_matype = 0,
                           int slowd_n = 3, int slowd_matype = 0);

Indicator HAYAKU_API TA_STOCHF(int fastk_n = 5, int fastd_n = 3, int fastd_matype = 0);
Indicator HAYAKU_API TA_STOCHF(const KData& k, int fastk_n = 5, int fastd_n = 3, int fastd_matype = 0);

Indicator HAYAKU_API TA_STOCHRSI(int n = 14, int fastk_n = 5, int fastd_n = 3, int matype = 0);
...
Indicator HAYAKU_API TA_ULTOSC(const KData& k, int n1 = 7, int n2 = 14, int n3 = 28);
