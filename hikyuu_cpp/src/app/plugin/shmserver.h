...
#include <string>
#include "data/DataType.h"  // Provides the empty fallback definition of HKU_API (mac/linux does
 ...
 *          the data runtime and calls its start(). The plugin requires a VIP license, false is
 *          returned
