...
def stage_headers(destination_root: Path) -> None:
    ...
    generated = {
        ...
        PYTHON_ROOT / "hayaku_pywrap/common/PybindSupport.h":
            include_root / "hayaku/python/PybindSupport.h",
        PYTHON_ROOT / "hayaku_pywrap/common/PickleSupport.h":
            include_root / "hayaku/python/PickleSupport.h",
        PYTHON_ROOT / "hayaku_pywrap/common/AnyConversion.h":
    ...
    (include_root / "hayaku/__init__.py").touch()
...
def main() -> None:
    ...
    parser.add_argument("--output-root", type=Path, default=PYTHON_ROOT)
