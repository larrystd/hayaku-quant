 ...
 * @ingroup DBConnect
 */
class HAYAKU_UTILS_API SQLStatementBase {
 public:
  /**
   * Constructor
  ...
  virtual int sub_getNumColumns()
      const = 0;  ///< Subclass interface @see getNumColumns
...
inline bool SQLStatementBase::moveNext() { return sub_moveNext(); }

inline void SQLStatementBase::bind(int idx) { sub_bindNull(idx); }
