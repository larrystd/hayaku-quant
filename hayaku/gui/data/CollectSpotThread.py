...
from hayaku.gui.spot_server import collect, release_nng_senders


class CollectSpotThread(QThread):
    def __init__(self, config, hayaku_config_file):
        super(self.__class__, self).__init__()
        self.working = True
        self._config = config
        self.hayaku_config_file = hayaku_config_file
    ...
    def __del__(self):
        release_nng_senders()
        hayaku_info("Quit CollectSpotThread")
