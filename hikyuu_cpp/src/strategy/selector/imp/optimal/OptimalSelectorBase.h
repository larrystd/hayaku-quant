...
public:
    ...
    virtual double evaluate(const internal::StrategyRuntimePtr& sys, const Datetime& endDate) noexcept {
        return Null<double>();
    }
...
public:                                       \
    ...
    virtual double evaluate(const internal::StrategyRuntimePtr&, const Datetime& endDate) noexcept override;
