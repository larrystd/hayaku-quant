 ...
 */
void HAYAKU_UTILS_API DBUpgrade(const DBConnectPtr &driver, const char *module_name,
  ...
  PRIMARY KEY (`id`)
    ...
    if (version >= to_version) {
        HAYAKU_TRACE("current version({}) greater the upgrade version({}), ignored!", version,
                  to_version);
        return;
    }
    ...
    HAYAKU_TRACE("update {} database ..., update script index: {}", module_name, start_index);
 ...
 */
net::awaitable<void> HAYAKU_UTILS_API DBUpgrade(const AsyncDBConnectPtr &driver,
