...
TelemetryInfo& telemetryInfo() {
    ...
    static const bool initialized = [] {
        info->latest_version_info.version =
          HAYAKU_VERSION_MAJOR * 1000000 + HAYAKU_VERSION_MINOR * 1000 + HAYAKU_VERSION_ALTER;
        return true;
    }();
    (void)initialized;
    return *info;
...
void HAYAKU_API reminderLicenseExpiration() {
    ...
    HAYAKU_WARN_IF(remain > Days(0) && remain < Days(10), "Note! Your license will expire in {} days.",
                remain.days());
}
