...
TradeRecord::TradeRecord()
    : business(BUSINESS_INVALID),
      ...
      stoploss(0.0),
      cash(0.0),
      from(OrderOrigin::UNSPECIFIED) {}

TradeRecord::TradeRecord(const Stock& stock, const Datetime& datetime,
                         BUSINESS business, price_t planPrice,
                         price_t realPrice, price_t goalPrice, double number,
...
string TradeRecord::toString() const {
  ...
  return fmt::format(
      ...
      cost.others, getOrderOriginName(from), remark);
}
