...
void SimplePortfolio::_runMomentOnOpen(const Datetime& date, const Datetime& nextCycle,
    ...
    HKU_INFO_IF(trace, "[PF] {}: {}, {}: {}, {}: {}", htr("The sum cash of subAccount"), sum_cash,
...
PortfolioPtr HKU_API PF_Simple(const internal::PortfolioAccountPortPtr& tm, const SEPtr& st, const AFPtr& af, int adjust_cycle,
