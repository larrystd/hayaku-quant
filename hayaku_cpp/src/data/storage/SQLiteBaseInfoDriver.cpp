...
#include "HistoryFinanceFieldTable.h"
#include "HistoryFinanceTable.h"
#include "HolidayTable.h"
#include "MarketInfoTable.h"
#include "StockTable.h"
#include "StockTypeInfoTable.h"
#include "StockWeightTable.h"
#include "ZhBond10Table.h"
...
StockWeightList SQLiteBaseInfoDriver::getStockWeightList(const string& market,
                                                         const string& code,
                                                         Datetime start,
                                                         Datetime end) {
  HAYAKU_ASSERT(pool_);
...
SQLiteBaseInfoDriver::getAllStockWeightList() {
  ...
  try {
    ...
    con->batchLoadView(
        view,
        "SELECT a.id AS id, (market.market || stock.code) AS market_code, "
        "a.date, "
...
vector<HistoryFinanceInfo> SQLiteBaseInfoDriver::getHistoryFinance(
