...
: SignalBase("SG_Band"), m_ind(ind.clone()), m_lower(lower), m_upper(upper) {
    HAYAKU_CHECK(lower < upper, "BandSignal: lower track is greater than upper track");
}
...
SignalPtr HAYAKU_API SG_Band(const Indicator& sig, price_t lower, price_t upper) {
