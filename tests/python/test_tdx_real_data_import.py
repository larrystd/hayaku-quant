...
.. moduleauthor:: Hayaku Quant Framework <https://github.com/larrystd/hayaku-quant>
...
.. code-block:: shell
   ...
   pytest -v -rs -s tests/python/test_tdx_real_data_import.py
...
# 确保项目根目录在Python的模块搜索路径中, 以便正确导入hayaku库
...
from tests.python.test_init import get_real_tdx_filepath
...
class TestTdxRealDataImport(unittest.TestCase):
    ...
    @patch('hayaku.application.gui.tasks.UseTdxImportToH5Thread.TdxHq_API')
    @patch('hayaku.application.gui.tasks.UseTdxImportToH5Thread.sqlite_import_new_holidays')
    @patch('hayaku.application.gui.tasks.UseTdxImportToH5Thread.sqlite_import_index_name')
    @patch('hayaku.application.gui.tasks.UseTdxImportToH5Thread.sqlite_import_stock_name')
    @patch('hayaku.application.gui.tasks.UseTdxImportToH5Thread.sqlite_create_database')
    @patch('hayaku.application.gui.tasks.UseTdxImportToH5Thread.search_best_tdx')
