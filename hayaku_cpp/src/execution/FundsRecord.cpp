...
std::ostream& operator<<(std::ostream& os, const FundsRecord& funds) {
  ...
  os << "FundsRecord(" << funds.cash << strip << funds.market_value << strip
     << funds.short_market_value << strip << funds.base_cash << strip
     << funds.base_asset << strip << funds.borrow_cash << strip
     << funds.borrow_asset << ")";
...
FundsRecord::FundsRecord(price_t cash, price_t market_value,
                         price_t short_market_value, price_t base_cash,
                         price_t base_asset, price_t borrow_cash,
