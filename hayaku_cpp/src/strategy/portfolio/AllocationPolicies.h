...
/**
 * @brief Equal weight asset allocation, it allocates the selected assets in
 * equal proportions
 * @return AFPtr
...
/**
 * @brief Fixed amount allocation, the trade of every selected asset cannot
 * exceed this amount
...
/**
 * @brief Fixed proportion asset allocation, every selected asset accounts for a
 * fixed proportion of the total assets only
