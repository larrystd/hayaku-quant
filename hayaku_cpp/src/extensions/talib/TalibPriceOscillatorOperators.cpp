...
Indicator HAYAKU_API TA_MACDEXT(int fast_n, int slow_n, int signal_n, int fast_matype, int slow_matype,
                             int signal_matype) {
...
Indicator HAYAKU_API TA_STOCH(int fastk_n, int slowk_n, int slowk_matype, int slowd_n,
                           int slowd_matype) {
...
Indicator HAYAKU_API TA_STOCH(const KData& k, int fastk_n, int slowk_n, int slowk_matype, int slowd_n,
                           int slowd_matype) {
    auto p = make_shared<TaStoch>();
    p->setParam<int>("fastk_n", fastk_n);
    p->setParam<int>("slowk_n", slowk_n);
...
Indicator HAYAKU_API TA_STOCHF(const KData& k, int fastk_n, int fastd_n, int fastd_matype) {
    auto p = make_shared<TaStochf>();
    p->setParam<int>("fastk_n", fastk_n);
    p->setParam<int>("fastd_n", fastd_n);
    p->setParam<int>("fastd_matype", fastd_matype);
