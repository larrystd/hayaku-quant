 ...
 *
 * Construction accepts an explicit component definition and a narrow execution boundary. The
 * facade does not expose the mutable strategy runtime or account implementation.
 */
class HKU_API StrategyEngine {
public:
    ...
    /** Run the bound definition synchronously and return a stable result snapshot. */
