...
TEST_CASE("test_REFX") {
  ...
  data = PRICELIST(a, 3);
  expect =
      PRICELIST({null_value, 3, 4, 5, 6, 7, 8, 9, null_value, null_value}, 1);
  result = REFX(data, -2);
  check_indicator(result, expect);

  data = PRICELIST(a, 9);
  expect =
      PRICELIST({null_value, null_value, null_value, null_value, null_value,
                 null_value, null_value, 9, null_value, null_value},
                7);
  result = REFX(data, -2);
  check_indicator(result, expect);
  ...
  data = PRICELIST(a);
  expect =
      PRICELIST({9, null_value, null_value, null_value, null_value, null_value,
