...
public:
    ...
    virtual bool connect(const std::string& datadir, uint64_t waitTimeoutSec) noexcept = 0;
...
HAYAKU_API void setRealtimeDataSourceResolver(RealtimeDataSourceResolver resolver);
