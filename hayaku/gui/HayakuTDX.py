...
from hayaku.gui.data.MainWindow import *
from hayaku.gui.data.EscapetimeThread import EscapetimeThread
from hayaku.gui.data.UseTdxImportToH5Thread import UseTdxImportToH5Thread
from hayaku.gui.data.ImportTdxToH5Task import ImportTdxToH5Task
from hayaku.gui.data.UsePytdxImportToH5Thread import UsePytdxImportToH5Thread
from hayaku.gui.data.UseQmtImportToH5Thread import UseQmtImportToH5Thread
# from hayaku.gui.data.CollectToMySQLThread import CollectToMySQLThread
# from hayaku.gui.data.CollectToMemThread import CollectToMemThread
from hayaku.gui.data.CollectSpotThread import CollectSpotThread
from hayaku.gui.data.SchedImportThread import SchedImportThread
from hayaku.gui.spot_server import release_nng_senders

from hayaku import (can_upgrade, get_latest_version_info, is_valid_license,
                    get_expire_date, Datetime, TimeDelta)
from hayaku.data import hayaku_config_template
from hayaku.util import *
...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def initUI(self):
        ...
        icon = QIcon(f"{current_dir}/images/hayaku_small.png")
