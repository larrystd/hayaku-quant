...
FixedATradeCost::FixedATradeCost(price_t commission, price_t lowestCommission,
...
CostRecord FixedATradeCost::getBuyCost(const Datetime& datetime,
  ...
  result.commission =
      roundEx(price * num * getParam<price_t>("commission"), precision);
  ...
  if (stock.market() == "SH") {
    result.transferfee =
        num > 1000 ? roundEx(getParam<price_t>("transferfee") * num, precision)
...
CostRecord FixedATradeCost::getSellCost(const Datetime& datetime,
  ...
  if (stock.type() == STOCKTYPE_A || stock.type() == STOCKTYPE_GEM) {
    result.stamptax =
        roundEx(price * num * getParam<price_t>("stamptax"), precision);
  } else {
    result.stamptax = 0.0;
  }
...
CostRecord FixedA2015TradeCost::getBuyCost(const Datetime& datetime,
                                           const Stock& stock, price_t price,
                                           double num) const {
  CostRecord result;
  HAYAKU_WARN_IF_RETURN(stock.isNull(), result, "Stock is Null!");
  ...
  result.commission =
      roundEx(value * getParam<price_t>("commission"), precision);
  price_t lowestCommission = getParam<price_t>("lowest_commission");
  if (result.commission < lowestCommission) {
    result.commission = lowestCommission;
  }
  ...
  if (stock.market() == "SH") {
    result.transferfee =
        roundEx(value * getParam<price_t>("transferfee"), precision);
  }
...
CostRecord FixedA2015TradeCost::getSellCost(const Datetime& datetime,
                                            const Stock& stock, price_t price,
                                            double num) const {
  CostRecord result;
  HAYAKU_WARN_IF_RETURN(stock.isNull(), result, "Stock is Null!");
...
CostRecord FixedA2017TradeCost::getBuyCost(const Datetime& datetime,
                                           const Stock& stock, price_t price,
                                           double num) const {
  CostRecord result;
  HAYAKU_WARN_IF_RETURN(stock.isNull(), result, "Stock is Null!");
...
CostRecord FixedA2017TradeCost::getSellCost(const Datetime& datetime,
                                            const Stock& stock, price_t price,
                                            double num) const {
  CostRecord result;
  if (stock.isNull()) {
...
CostRecord FixedETFTradeCost::getBuyCost(const Datetime& datetime,
                                         const Stock& stock, price_t price,
                                         double num) const {
  CostRecord result;
  HAYAKU_WARN_IF_RETURN(stock.isNull(), result, "Stock is Null!");
...
CostRecord FixedETFTradeCost::getSellCost(const Datetime& datetime,
                                          const Stock& stock, price_t price,
                                          double num) const {
  CostRecord result;
  HAYAKU_WARN_IF_RETURN(stock.isNull(), result, "Stock is Null!");
...
CostRecord ZeroTradeCost ::getBuyCost(const Datetime& datetime,
                                      const Stock& stock, price_t price,
                                      double num) const {
  return CostRecord();
}

CostRecord ZeroTradeCost ::getSellCost(const Datetime& datetime,
                                       const Stock& stock, price_t price,
                                       double num) const {
  return CostRecord();
}
...
CostRecord TradeCostStub::getBuyCost(const Datetime& datetime,
                                     const Stock& stock, price_t price,
                                     double num) const {
  return CostRecord(0, 0, 0, 10, 10);
}

CostRecord TradeCostStub::getSellCost(const Datetime& datetime,
                                      const Stock& stock, price_t price,
                                      double num) const {
  return CostRecord(0, 0, 0, 20, 20);
}

CostRecord TradeCostStub::getBorrowCashCost(const Datetime& datetime,
                                            price_t cash) const {
...
CostRecord TradeCostStub::getBorrowStockCost(const Datetime& datetime,
                                             const Stock& stock, price_t price,
                                             double num) const {
...
TradeCostPtr TradeCostStub::_clone() { return make_shared<TradeCostStub>(); }
