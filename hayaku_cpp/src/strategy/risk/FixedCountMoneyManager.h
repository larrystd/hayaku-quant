 ...
 * @details A fixed quantity is bought every time; if the account balance is
 * insufficient, enough funds are deposited into the account to guarantee that
 * the buy can be executed. That is, the funds are always assumed to be
 * sufficient.
