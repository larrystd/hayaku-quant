 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API ADVANCE(const KQuery& query = KQueryByIndex(-100), const string& market = "SH",
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API DECLINE(const KQuery& query = KQueryByIndex(-100), const string& market = "SH",
                          int stk_type = STOCKTYPE_A, bool ignore_context = false,
                          bool fill_null = true);
 ...
 * @return Indicator
 */
Indicator HAYAKU_API INBLOCK(const KData& kdata, const string& category, const string& name);
 ...
 * @return Indicator
 */
Indicator HAYAKU_API INSUM(const Block& block, const KQuery& query, const Indicator& ind, int mode,
                        bool fill_null = true);

Indicator HAYAKU_API INSUM(const Block& block, const Indicator& ind, int mode, bool fill_null = true);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API CYCLE(const KData& k, int adjust_cycle = 1, const string& adjust_mode = "query",
                        bool delay_to_trading_day = true);
Indicator HAYAKU_API CYCLE(int adjust_cycle = 1, const string& adjust_mode = "query",
                        bool delay_to_trading_day = true);
...
Indicator HAYAKU_API ZHBOND10(const DatetimeList& dates, double default_val = 4.0);
