...
HAYAKU_PLUGIN_EXPORT uint32_t hayakuPluginAbiVersion() noexcept { return hayaku::HAYAKU_PLUGIN_ABI_VERSION; }
HAYAKU_PLUGIN_EXPORT uint32_t hayakuPluginInterfaceVersion() noexcept { return 1; }
HAYAKU_PLUGIN_EXPORT const char* hayakuPluginId() noexcept { return "hayaku_abi_no_destroy"; }
