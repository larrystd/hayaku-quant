...
private:
    ...
    void parseSpotData(const void* buf, size_t buf_len, const Datetime& startReceiveTime);
...
private:
    ...
    std::atomic_bool m_cleanupPending = false;  // Worker resources still require an external join
