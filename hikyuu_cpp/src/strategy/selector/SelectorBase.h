...
#include "strategy/multifactor/MultiFactorBase.h"
...
public:
     ...
     */
    void addStock(const Stock& stock, const internal::StrategyRuntimePtr& protoSys);
     ...
     * @param protoSys trading system strategy prototype
     */
    void addStockList(const StockList& stkList, const internal::StrategyRuntimePtr& protoSys);
     ...
     * calculation */
    virtual void calculate(const internal::StrategyRuntimeList& pf_realSysList, const KQuery& query);

    /* Called by PF only, it builds the mapping from the actual systems to the prototype systems */
    virtual void bindRealToProto(const internal::StrategyRuntimePtr& real, const internal::StrategyRuntimePtr& proto) {}
...
protected:
    ...
    internal::StrategyRuntimeList m_real_sys_list;  // The systems actually run in the PF portfolio, set when PF
...
inline const internal::StrategyRuntimeList& SelectorBase::getRealSystemList() const {
    return m_real_sys_list;
}

inline const internal::StrategyRuntimeList& SelectorBase::getProtoSystemList() const {
