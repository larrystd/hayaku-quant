...
public:
     ...
     *         DataRuntime::releaseShmServerBaseInfoCache() releases the local weight cache of each
     ...
     * by DataRuntime::releaseShmServerBaseInfoCache() (invoked by the shm server role once the
