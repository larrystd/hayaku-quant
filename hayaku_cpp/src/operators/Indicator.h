 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API IF(const Indicator& x, const Indicator& a, const Indicator& b);
Indicator HAYAKU_API IF(const Indicator& x, Indicator::value_t a, const Indicator& b);
Indicator HAYAKU_API IF(const Indicator& x, const Indicator& a, Indicator::value_t b);
Indicator HAYAKU_API IF(const Indicator& x, Indicator::value_t a, Indicator::value_t b);
 ...
 * @ingroup Indicator
 */
IndicatorList HAYAKU_API combineCalculateIndicators(const IndicatorList& indicators,
...
inline string to_string(const hayaku::Indicator& ind) {
    return ind.str();
}
}  // namespace std
