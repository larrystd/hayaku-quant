...
from hayaku.extensions.ingest.backends.common_h5 import H5Record, get_h5table, open_h5file
# 假设要测试的函数位于以下模块
from hayaku.extensions.ingest.jobs.tdx_to_h5 import tdx_import_day_data_from_file
