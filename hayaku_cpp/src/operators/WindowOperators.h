...
Indicator HAYAKU_API AMA(const IndParam& n, const IndParam& fast_n, int slow_n = 30);
 ...
 * @ingroup Indicator
 */
Indicator HAYAKU_API DMA(const Indicator& x, const Indicator& a, bool fill_null = true);
