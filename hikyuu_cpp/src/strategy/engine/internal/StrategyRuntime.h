...
#pragma once
#ifndef HIKYUU_TRADE_SYS_ENGINE_INTERNAL_STRATEGYRUNTIME_H
#define HIKYUU_TRADE_SYS_ENGINE_INTERNAL_STRATEGYRUNTIME_H
...
public:
    StrategyRuntime(const StrategyDefinition& definition, ExecutionAccountPortPtr account);
    ...
    [[nodiscard]] TradeRecord sellForceOnOpen(const Datetime& datetime, double number,
                                              OrderOrigin origin);
    [[nodiscard]] TradeRecord sellForceOnClose(const Datetime& datetime, double number,
                                               OrderOrigin origin);
...
private:
    ...
    [[nodiscard]] double getBuyNumber(const Datetime&, price_t, price_t, OrderOrigin);
    [[nodiscard]] double getSellNumber(const Datetime&, price_t, price_t, OrderOrigin);
    [[nodiscard]] double getSellShortNumber(const Datetime&, price_t, price_t, OrderOrigin);
    [[nodiscard]] double getBuyShortNumber(const Datetime&, price_t, price_t, OrderOrigin);
    [[nodiscard]] price_t getStoplossPrice(const KRecord&, const KRecord&, price_t);
    [[nodiscard]] price_t getShortStoplossPrice(const KRecord&, const KRecord&, price_t);
    ...
    [[nodiscard]] TradeRecord runMomentOnOpenNative(const KRecord&, const KRecord&);
    [[nodiscard]] TradeRecord runMomentOnCloseNative(const KRecord&, const KRecord&);
    ...
    [[nodiscard]] TradeRecord sellNow(const KRecord&, const KRecord&, OrderOrigin);
    ...
    [[nodiscard]] TradeRecord sellShort(const KRecord&, const KRecord&, OrderOrigin);
    [[nodiscard]] TradeRecord sellShortNow(const KRecord&, const KRecord&, OrderOrigin);
    ...
    [[nodiscard]] TradeRecord buyShort(const KRecord&, const KRecord&, OrderOrigin);
    [[nodiscard]] TradeRecord buyShortNow(const KRecord&, const KRecord&, OrderOrigin);
    ...
    [[nodiscard]] TradeRecord sellForce(const Datetime&, double, OrderOrigin, bool onOpen);
...
#endif /* HIKYUU_TRADE_SYS_ENGINE_INTERNAL_STRATEGYRUNTIME_H */
