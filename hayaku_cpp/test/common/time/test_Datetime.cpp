...
/**
 * @defgroup test_hayaku_Datetime test_hayaku_Datetime
 * @ingroup test_hayaku_datetime_suite
 * @{
 */
...
TEST_CASE("test_Datetime") {
  ...
  CHECK(Datetime(201812310110).endOfDay() ==
  ...
  CHECK_EQ(Datetime::max().ticks(),
           (Datetime::max() - Datetime::min()).ticks());
}
