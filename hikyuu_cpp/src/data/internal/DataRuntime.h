...
#pragma once
#ifndef HIKYUU_DATA_INTERNAL_DATARUNTIME_H
#define HIKYUU_DATA_INTERNAL_DATARUNTIME_H
...
#include "common/plugin/PluginManager.h"
#include "data/driver/DataDriverFactory.h"
#include "app/plugin/interface/ShmServerPluginInterface.h"
 ...
 * even if the data runtime has not been initialized yet
 */
...
inline const Parameter& DataRuntime::getHikyuuParameter() const {
...
inline void DataRuntime::setPluginPath(const std::string& path) {
    m_plugin_manager.pluginPath(path);
}

template <typename PluginInterfaceT>
inline PluginInterfaceT* DataRuntime::getPlugin(const std::string& pluginname,
                                                bool print) noexcept {
...
#endif /* HIKYUU_DATA_INTERNAL_DATARUNTIME_H */
