...
class HAYAKU_API KDataImp : public enable_shared_from_this<KDataImp> {
 public:
  ...
  virtual size_t startPos() const { return 0; }

  virtual size_t endPos() const { return 0; }

  virtual size_t lastPos() const { return 0; }
  ...
  virtual const KRecord& front() const { return KRecord::NullKRecord; }

  virtual const KRecord& back() const { return KRecord::NullKRecord; }

  virtual const KRecord* data() const noexcept { return nullptr; }

  virtual KRecord* data() noexcept { return nullptr; }

  virtual DatetimeList getDatetimeList() const { return DatetimeList(); }
