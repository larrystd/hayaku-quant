...
.. code-block:: shell
   ...
   pytest -v -rs -s hayaku/test/test_tdx_real_data_import.py
...
from hayaku.test.test_init import get_real_tdx_filepath
...
class TestTdxRealDataImport(unittest.TestCase):
    ...
    @patch('hayaku.gui.data.UseTdxImportToH5Thread.TdxHq_API')
    @patch('hayaku.gui.data.UseTdxImportToH5Thread.sqlite_import_new_holidays')
    @patch('hayaku.gui.data.UseTdxImportToH5Thread.sqlite_import_index_name')
    @patch('hayaku.gui.data.UseTdxImportToH5Thread.sqlite_import_stock_name')
    @patch('hayaku.gui.data.UseTdxImportToH5Thread.sqlite_create_database')
    @patch('hayaku.gui.data.UseTdxImportToH5Thread.search_best_tdx')
