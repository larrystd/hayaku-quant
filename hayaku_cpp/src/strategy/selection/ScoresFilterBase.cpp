...
HAYAKU_API std::ostream& operator<<(std::ostream& out, const ScoresFilterBase& scfilter) {
    out << "SCFilter{";
...
HAYAKU_API std::ostream& operator<<(std::ostream& out, const ScoresFilterPtr& scfilter) {
    if (scfilter) {
        out << *scfilter;
    } else {
        out << "SCFilter(NULL)";
