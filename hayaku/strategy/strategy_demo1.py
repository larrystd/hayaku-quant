...
#
# Warning: Hayaku is a quantitative research tool and does not include a programmatic trading interface itself. This part is only an example of the strategy scheduling runtime,
...
from hayaku import Datetime, Query, Stock, open_session
from hayaku.core import Minutes, Seconds, SpotRecord, Strategy
...
#   2. Please enable the HayakuTdx quote collection, otherwise no data can be received
