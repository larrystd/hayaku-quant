...
#include "common/plugin/PluginBase.h"
#include "data/driver/BaseInfoDriver.h"
#include "data/driver/BlockInfoDriver.h"
#include "data/driver/KDataDriver.h"
...
public:
     ...
     * @param datadir data directory; the current data directory of the data runtime is used when it
     *                is empty
    ...
    // this interface) ─────────────────────────
    // It is called by the data-runtime client negotiation path only (use_shm_server is enabled and
    // this process is not in the server role). The signatures involve the core library data types
    // only, no plugin private type appears in the interface.
