...
BrokerPositionRecord::BrokerPositionRecord(const Stock& stock_, price_t number_,
                                           price_t money_)
...
BrokerPositionRecord& BrokerPositionRecord::operator=(
    BrokerPositionRecord&& rv) {
  if (this != &rv) {
...
string BrokerPositionRecord::str() const {
  return fmt::format("BrokerPositionRecord({}, {:<.4f}, {:<.4f})",
...
void OrderBrokerBase::buy(Datetime datetime, const string& market,
...
void OrderBrokerBase::sell(Datetime datetime, const string& market,
                           const string& code, price_t price, double num,
