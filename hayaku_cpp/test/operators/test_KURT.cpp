...
TEST_CASE("test_KURT") {
  ...
  // The excess kurtosis of a uniform distribution should be close to -1.2 (a
  // finite sample deviates)
  ...
  // The excess kurtosis of a uniform distribution should be between -1.5 and
  // -1.0
...
TEST_CASE("test_KURT_benchmark") {
  ...
  {
    BENCHMARK_TIME_MSG(test_KURT_benchmark, cycle,
