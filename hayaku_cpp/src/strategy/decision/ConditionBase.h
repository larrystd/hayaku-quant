...
private:
    ...
    void save(Archive& ar, const unsigned int version) const {
        ...
        // m_kdata/m_account/m_sg are set temporarily when the strategy runs and are not serialized
        // serialized
    }
...
inline void ConditionBase::setAccount(const internal::ExecutionAccountPortPtr& account) {
    m_account = account;
}
...
template <>
struct fmt::formatter<hayaku::ConditionBase> : ostream_formatter {};

template <>
struct fmt::formatter<hayaku::ConditionPtr> : ostream_formatter {};
#endif
