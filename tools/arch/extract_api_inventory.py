...
BINDING_GLOBS = (
    "python/hayaku_pywrap/**/*.cpp",
)

PYTHON_EXPORT_FILES = (
    "python/hayaku/__init__.py",
    "python/hayaku/core.py",
    "python/hayaku/application/interactive.py",
    "python/hayaku/common/_extensions.py",
    "python/hayaku/data/_extensions.py",
    "python/hayaku/operators/__init__.py",
    "python/hayaku/operators/_extensions.py",
    "python/hayaku/operators/formulas.py",
    "python/hayaku/data/__init__.py",
    "python/hayaku/execution/__init__.py",
    "python/hayaku/strategy/__init__.py",
    "python/hayaku/metrics/__init__.py",
    "python/hayaku/common/__init__.py",
    "python/hayaku/extensions/realtime/__init__.py",
    "python/hayaku/extensions/ingest/__init__.py",
    "python/hayaku/extensions/visualization/__init__.py",
)
...
def render(cpp_rows: list[CppApi], bindings: list[PythonBinding]) -> str:
    ...
    lines = [
        ...
        f"| pybind11 declarations in all binding files | {len(bindings)} |",
