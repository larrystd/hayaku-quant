...
TEST_CASE("test_SLICE") {
  ...
  /** @arg The PriceList is not empty, get part of the data with a positive
   * index */
  ...
  /** @arg The PriceList is not empty, get part of the data with a negative
   * index */
  ...
  /** @arg The PriceList is not empty, get part of the data with positive and
   * negative indexes */
