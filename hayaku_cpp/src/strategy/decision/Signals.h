 ...
 * @return SignalPtr
 */
SignalPtr HAYAKU_API SG_Band(const Indicator& ind, price_t lower, price_t upper);
 ...
 * @return SignalPtr
 */
SignalPtr HAYAKU_API SG_Band(const Indicator& ind, const Indicator& lower, const Indicator& upper);
 ...
 * @ingroup Signal
 */
SignalPtr HAYAKU_API SG_Bool(const Indicator& buy, const Indicator& sell, bool alternate = true);
 ...
 * @ingroup Signal
 */
SignalPtr HAYAKU_API SG_Single(const Indicator& ind, int filter_n = 20, double filter_p = 0.1);
 ...
 * @ingroup Signal
 */
SignalPtr HAYAKU_API SG_Single2(const Indicator& ind, int filter_n = 20, double filter_p = 0.1);
