...
#pragma once
#ifndef HIKYUU_TRADE_TRADERECORD_H
#define HIKYUU_TRADE_TRADERECORD_H
...
public:
    ...
    TradeRecord(const Stock& stock, const Datetime& datetime, BUSINESS business, price_t planPrice,
                ...
                price_t stoploss, price_t cash, OrderOrigin from, const string& remark = "");
...
#endif /* HIKYUU_TRADE_TRADERECORD_H */
