...
void export_Indicator_build_in(py::module& m) {
    ...
    m.def("CONTEXT", py::overload_cast<const Indicator&, bool, bool, bool>(hayaku::CONTEXT),
    ...
    m.def("CONTEXT", py::overload_cast<const Indicator&, const Stock&, bool>(hayaku::CONTEXT),
   ...
   :rtype: Indicator)");
    ...
    m.def("WEAVE", [](const py::sequence& seq) {
        ...
        HAYAKU_CHECK(total >= 2 && total <= 6, "{}", htr("WEAVE: total must be 2 to 6"));
