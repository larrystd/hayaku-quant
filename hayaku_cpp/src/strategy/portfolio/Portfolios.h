 ...
 */
PortfolioPtr HAYAKU_API PF_Simple(const internal::PortfolioAccountPortPtr& tm = internal::PortfolioAccountPortPtr(), const SEPtr& se = SE_Fixed(),
 ...
 * @param strategy_use_own_account use the prototype strategy account for the calculation
 ...
 * @return the portfolio instance
 */
PortfolioPtr HAYAKU_API PF_WithoutAF(const internal::PortfolioAccountPortPtr& tm = internal::PortfolioAccountPortPtr(), const SEPtr& se = SE_Fixed(),
